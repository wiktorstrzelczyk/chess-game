...
import infrastructure.BoardToStringConverter
import infrastructure.SimpleBoardToStringConverter
...
private class BoardTest {
    ...
    fun `cannot make move that causes own check`() {
        ...
        println(SimpleBoardToStringConverter().convert(board, PLAYER_WHITE))
